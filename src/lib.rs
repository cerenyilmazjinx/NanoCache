...
#[derive(Debug)]
pub struct NanoCacheProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NanoCacheProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NanoCache processing");
    
    let mut processor = NanoCacheProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NanoCacheProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NanoCacheProcessor::new(false);
